...
% Mostramos el indice tal cual lo genero la compilacion completa del documento,
% leyendo directamente su archivo .toc (con los numeros de pagina reales).
...
\clearpage
{\cfttoctitlefont\contentsname\par}
\vspace{\cftaftertoctitleskip}
\begingroup
  \makeatletter
  \let\@dotsep\relax
  \input{indice-completo.toc}
  \makeatother
\endgroup
