...
La elección de XP como metodología de referencia se fundamenta en una comparación con otras alternativas ampliamente utilizadas. Scrum, aunque popular en equipos de desarrollo profesional, presupone roles diferenciados \textit{Product Owner}, \textit{Scrum Master} y equipo de desarrollo y una estructura de ceremonias formales que no se corresponden con la naturaleza unipersonal de este proyecto \parencite{schwaber2020}. Kanban, por su parte, ofrece flexibilidad en la gestión del flujo de trabajo, pero carece de los mecanismos de planificación por valores y retroalimentación continua que XP incorpora de manera explícita \parencite{anderson2010}. En contraste, XP está diseñado para contextos donde el equipo es reducido, los requisitos evolucionan durante el desarrollo y la calidad del software es una prioridad sostenida a lo largo de todo el proceso.
...
De las prácticas que XP propone, este proyecto incorpora de manera explícita el desarrollo iterativo e incremental, la integración continua de retroalimentación como insumo de corrección y la validación sostenida de decisiones de diseño y arquitectura. No se adoptaron prácticas que presuponen equipos de múltiples integrantes, como la programación en parejas o la propiedad colectiva del código, dado que el proyecto es desarrollado por un equipo de dos personas con responsabilidades claramente delimitadas. Esta adaptación parcial de XP es consistente con lo señalado por \textcite{shore2021}, quienes reconocen que los equipos pueden seleccionar un subconjunto coherente de prácticas XP sin comprometer los principios fundamentales de la metodología.
