...
Gestión de contenido (CMS) y sitio informativo & Iteraciones 0, 1 y 2 & 9 semanas \\ \hline
Competencias y tareas & Iteraciones posteriores del proyecto & Según alcance del módulo \\ \hline
Registro y administración de participantes & Iteraciones posteriores del proyecto & Según alcance del módulo \\ \hline
Evaluación digital e imprimible & Iteraciones posteriores del proyecto & Según alcance del módulo \\ \hline
\end{tabular}
\caption[Correspondencia entre módulos e iteraciones]{Correspondencia entre los módulos del sistema y las iteraciones de desarrollo de tres semanas}
