...
Siguiendo el principio de iteraciones cortas de duración fija propio de XP, el desarrollo se organizó en \textit{iteraciones de dos semanas} (\textit{timeboxing}). La duración de la iteración se mantiene constante a lo largo de todo el proyecto: lo que varía entre una y otra no es el tiempo asignado, sino la cantidad de historias de usuario que se planifican y completan en cada una. De esta forma, la duración fija funciona como una unidad estable de medición del avance, que permite estimar la velocidad de desarrollo y la fecha de finalización del proyecto.

Dado que los módulos del sistema presentan distinta extensión y complejidad, no existe una correspondencia directa entre un módulo y una única iteración. En lugar de extender la duración de una iteración para acomodar un módulo de mayor tamaño, cada módulo se desarrolla a lo largo del número de iteraciones que requiera, manteniendo invariable la caja de tiempo de dos semanas. En este proyecto, cada uno de los cuatro módulos se desarrolla en dos iteraciones, lo que totaliza ocho iteraciones de desarrollo. La Tabla~\ref{tab:iteraciones_modulos} presenta la correspondencia entre los módulos del sistema y las iteraciones que los componen.

\begin{table}[H]
\centering
\caption[Correspondencia entre módulos e iteraciones]{Correspondencia entre los módulos del sistema y las iteraciones de desarrollo de dos semanas}
\label{tab:iteraciones_modulos}
\renewcommand{\arraystretch}{1.25}
\begin{tabular}{|p{5.5cm}|p{4cm}|p{3.5cm}|}
\hline
\textbf{Módulo} & \textbf{Iteraciones} & \textbf{Duración} \\ \hline
Gestión de contenido (CMS) y sitio informativo & Iteraciones 1 y 2 & 4 semanas \\ \hline
Competencias y tareas & Iteraciones 3 y 4 & 4 semanas \\ \hline
Registro y administración de participantes & Iteraciones 5 y 6 & 4 semanas \\ \hline
Evaluación digital e imprimible & Iteraciones 7 y 8 & 4 semanas \\ \hline
\end{tabular}
\end{table}

\subsection{Diseño centrado en el usuario e interacción persona computadora}

Complementariamente a XP, el desarrollo de la plataforma incorporó principios de diseño centrado en el usuario (\textit{User-Centered Design}, UCD), definidos en la norma \textcite{iso9241210}. Este enfoque establece que las decisiones de diseño deben fundamentarse en el conocimiento de los usuarios, sus tareas y su contexto de uso, con el propósito de producir sistemas que sean utilizables, accesibles y adecuados a las necesidades reales de quienes los emplean.

La pertinencia de este enfoque en el presente proyecto se deriva de la diversidad de perfiles de usuario que interactúan con la plataforma. El sistema contempla cuatro tipos de actores principales: los \textbf{administradores} del sistema, responsables de la configuración global del concurso; los \textbf{coordinadores institucionales}, encargados de gestionar la inscripción de sus unidades educativas y los participantes a su cargo; los \textbf{docentes}, que supervisan la participación de sus estudiantes; y los \textbf{estudiantes} de nivel primario y secundario, cuya interacción con el sistema se concentra en el módulo de resolución de tareas. Cada uno de estos actores presenta competencias digitales, objetivos y contextos de uso diferentes, lo que hace que las decisiones de interfaz no puedan abordarse de manera uniforme. Las definiciones de navegación, estructura de información y presentación de contenido se orientaron en función de los requisitos específicos de cada rol, tomando como referencia los principios de usabilidad descritos por \textcite{norman2013}.
...
La selección de las tecnologías descritas no respondió únicamente a criterios funcionales aislados, sino a una evaluación conjunta de sostenibilidad técnica, consumo de recursos, capacidad de escalamiento y afinidad con la experiencia previa del equipo de desarrollo. En este sentido, se priorizaron herramientas consolidadas, activamente mantenidas y adecuadas para una infraestructura moderada, evitando depender de soluciones excesivamente recientes o inciertas en su continuidad. La Tabla~\ref{tab:criterios_tecnologias} sintetiza estos criterios de selección.
    ...
    Astro & Eficiencia y optimización en frontend & La landing page no requiere reactividad compleja; minimizar JavaScript en cliente reduce tiempos de carga en conexiones lentas, condición frecuente en el contexto boliviano. 
    \\ \hline
